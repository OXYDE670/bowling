...
Strings = {
    ['press_start'] = ' ~INPUT_PICKUP~ Basarak Bowling Topunu Al',
    ['next_last_select'] = '~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_LEFT~ Kulvar Değiş\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Seç\n~INPUT_FRONTEND_RRIGHT~ İptal',
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ Yön Ver\n~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Güç \n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ Kamere Değiş\n~INPUT_ATTACK~ At\n~INPUT_FRONTEND_RRIGHT~ İptal',
    ['force'] = 'Güç: %s',
    ['strike'] = {'WOW! ÇEKIÇ GIBI!', 'HARIKA!!'},
    ['spare'] = {'Bowling', 'İyi oyun! Maalesef hiçbir şey.'},
    ['x_pinsdown'] = {'Bowling', 'Bu oyun %s te %s yaptın'},
    ['this_occupied'] = 'Bu bowling salonu dolu.',
    ['every_occupied'] = 'Tamamen doluyuz.',
    ['blip'] = 'Bowling'
}